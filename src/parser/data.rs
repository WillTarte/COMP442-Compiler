...
pub const EXPRAMB1_FIRST: &'static [GrammarSymbol] = &[Terminal(Assignment),Terminal(NotEq),Terminal(LessThan),Terminal(GreaterThan),Terminal(LessEqualThan),Terminal(GreaterEqualThan), EPSILON];
...
pub const FACTORAMB1_FIRST: &'static [GrammarSymbol] = &[Terminal(OpenSquare),Terminal(OpenParen),Terminal(Period),EPSILON];
...
pub const FUNCPARAMS_FIRST: &'static [GrammarSymbol] = &[Terminal(Id),Terminal(IntegerType),Terminal(FloatType),Terminal(StringType),EPSILON];
...
pub const PARAMS_FIRST: &'static [GrammarSymbol] = &[Terminal(Plus),Terminal(Minus),Terminal(Id),Terminal(IntegerLit),Terminal(FloatLit),Terminal(StringLit),Terminal(OpenParen),Terminal(Bang),Terminal(Question),EPSILON];
...
pub const REPTCLASSDECL_FIRST: &'static [GrammarSymbol] = &[Terminal(Id),Terminal(Func),Terminal(IntegerType),Terminal(FloatType),Terminal(StringType),Terminal(Public),Terminal(Private),EPSILON];
pub const REPTCLASSDECL_FOLLOW: &'static [GrammarSymbol] = &[Terminal(CloseCurly)];
pub const REPTFUNCBODY_FIRST: &'static [GrammarSymbol] = &[Terminal(Id),Terminal(If),Terminal(While),Terminal(Read),Terminal(Write),Terminal(Return),Terminal(Break),Terminal(Continue),EPSILON];
...
pub const REPTOPTFUNCBODY_FIRST: &'static [GrammarSymbol] = &[Terminal(Id),Terminal(IntegerType),Terminal(FloatType),Terminal(StringType),EPSILON];
...
pub const REPTSTATBLOCK_FIRST: &'static [GrammarSymbol] = &[Terminal(Id),Terminal(If),Terminal(While),Terminal(Read),Terminal(Write),Terminal(Return),Terminal(Break),Terminal(Continue),EPSILON];
...
pub const RIGHTRECARITHEXPR_FIRST: &'static [GrammarSymbol] = &[Terminal(Plus),Terminal(Minus),Terminal(Or),EPSILON];
...
pub const RIGHTRECTERM_FIRST: &'static [GrammarSymbol] = &[Terminal(Mult),Terminal(Div),Terminal(And),EPSILON];
...
pub const STATBLOCK_FIRST: &'static [GrammarSymbol] = &[Terminal(Id),Terminal(OpenCurly),Terminal(If),Terminal(While),Terminal(Read),Terminal(Write),Terminal(Return),Terminal(Break),Terminal(Continue),EPSILON];
...
pub const VARIABLEAMB1_FIRST: &'static [GrammarSymbol] = &[Terminal(OpenSquare),Terminal(OpenParen),Terminal(Period),EPSILON];
pub const VARIABLEAMB1_FOLLOW: &'static [GrammarSymbol] = &[Terminal(CloseParen)];
pub const VISIBILITY_FIRST: &'static [GrammarSymbol] = &[Terminal(Public),Terminal(Private),EPSILON];
